...
class _CommentsSectionState extends State<CommentsSection> {
  ...
  void _handleToggleTap() {
    ...
    // Розгортання лише показує секцію — ЗАВЖДИ, незалежно від того, є вже
    // коментарі чи нема. Раніше порожня секція одразу й фокусувала поле
    // "бо очевидно писати", а непорожня — ні; ця асиметрія й була джерелом
    // "чому тут по-іншому" — тепер поле фокусується лише прямим тапом у
    // нього, без винятків.
